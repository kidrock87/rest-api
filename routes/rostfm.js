              ...
              config: {
                  validate: {
                      payload: {
                          firstname: Joi.any(),
                          email: Joi.any(),
                          tematika: Joi.any().optional(),
                          site: Joi.any().optional(),
            ...
            server.route({
              ...
              server.route({
                ...
                server.route({
                      ...
                      db.admin.count({"ref_id" : request.payload.user_id},(err, ref_count) => {
